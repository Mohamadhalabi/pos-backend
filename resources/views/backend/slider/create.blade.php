                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" @if($key == 0) required @endif
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" id="ends_on_{{ $language->code }}" 
                                               name="ends_on_{{ $language->code }}" value="{{ old('ends_on_' . $language->code) }}">
                        ...
                        <div class="col align-items-center">
                            <div class="form-group align-items-center">
                                ...
                                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-30px" @if(old('status') == 1) checked @endif type="checkbox" value="1" name="status" id="status"/>
